...
public interface PrayAgainstPlayerCConfig extends Config
{
    @ConfigItem(
            ...
            name = "Attacker color",
            description = "This color will be used for attackers weilding an unknown weapon"
    )
    ...
    @ConfigItem(
            position = 21,
            keyName = "meleeAttackerColor",
            name = "Melee Attacker Color",
            description = "Color for players using melee attacks"
    )
    default Color meleeAttackerColor()
    {
    ...
    @ConfigItem(
            position = 22,
            keyName = "rangedAttackerColor",
            name = "Ranged Attacker Color",
            description = "Color for players using ranged attacks"
    )
    default Color rangedAttackerColor()
    {
        return new Color(0, 0, 255, 100);
    }
    ...
    @ConfigItem(
            position = 23,
            keyName = "magicAttackerColor",
            name = "Magic Attacker Color",
            description = "Color for players using magic attacks"
    )
    default Color magicAttackerColor()
    {
        return new Color(0, 0, 255, 100);
    }
}