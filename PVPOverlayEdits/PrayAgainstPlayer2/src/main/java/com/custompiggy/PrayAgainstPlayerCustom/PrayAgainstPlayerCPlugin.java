...
public class PrayAgainstPlayerCPlugin extends Plugin {
    ...
    @Inject
    private PrayAgainstPlayerCConfig config;
    ...
    @Provides
    PrayAgainstPlayerCConfig provideConfig(ConfigManager configManager) {
        return configManager.getConfig(PrayAgainstPlayerCConfig.class);
    }
